...
MUNTIPLAYERHORRORIP_API UClass* Z_Construct_UClass_AShooterPickup();
...
MUNTIPLAYERHORRORIP_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_MuntiplayerHorrorIP(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 1771859217U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 4031013087U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_2598395905{
	TEXT("/Script/MuntiplayerHorrorIP"),
	Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_Weapons_ShooterPickup_h__Script_MuntiplayerHorrorIP_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
