...
MUNTIPLAYERHORRORIP_API UClass* Z_Construct_UClass_AShooterNPC();
MUNTIPLAYERHORRORIP_API UClass* Z_Construct_UClass_AShooterNPC_NoRegister();
MUNTIPLAYERHORRORIP_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
...
struct Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_MuntiplayerHorrorIP, nullptr, "PawnDeathDelegate__DelegateSignature", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_MuntiplayerHorrorIP_PawnDeathDelegate__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterNPC_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterNPC, IShooterWeaponHolder), false },  // 2368325209
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_AI_ShooterNPC_h__Script_MuntiplayerHorrorIP_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterNPC, AShooterNPC::StaticClass, TEXT("AShooterNPC"), &Z_Registration_Info_UClass_AShooterNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterNPC), 4008106372U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_AI_ShooterNPC_h__Script_MuntiplayerHorrorIP_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_AI_ShooterNPC_h__Script_MuntiplayerHorrorIP_1261005500{
	TEXT("/Script/MuntiplayerHorrorIP"),
	Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_AI_ShooterNPC_h__Script_MuntiplayerHorrorIP_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mdmun_Documents_GitHub_GameEngine2_GroupProject_MuntiplayerHorrorIP_Source_MuntiplayerHorrorIP_Variant_Shooter_AI_ShooterNPC_h__Script_MuntiplayerHorrorIP_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
